...
abstract class AbstractFunction1[@specialized(Int, Long, Double) -T1, @specialized(Unit, Int, Long, Double) +R] extends Function1[T1, R] { }
abstract class AbstractFunction2[@specialized(Int, Long, Double) -T1, @specialized(Int, Long, Double) -T2, @specialized(Unit, Int, Long, Double) +R] extends Function2[T1, T2, R] { }
